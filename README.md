...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kfdmrzk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kfdmrzk.containers.anotherwebservice.com/
...
```
git clone git@github.com:ellisonsparks2-pixel/container-kfdmrzk.git
cd container-kfdmrzk
```
...
```
docker attach container-kfdmrzk
```
